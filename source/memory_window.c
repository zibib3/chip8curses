...
/*
 * @brief get an address in the rom, and return the corresponding byte.
 *		  if the address is pc, add color to the byte.
 */
static chtype get_colored_memory(size_t address)
{
...
/*
 * @brief recalculate the memory screen.
 */
